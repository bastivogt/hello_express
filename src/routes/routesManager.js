...
routesManager.addRoute(
    new Route(Route.GET, "/", HomeController.index, "home:index")
);
routesManager.addRoute(
    new Route(Route.GET, "/hello", HomeController.hello, "home:hello")
);
routesManager.addRoute(
    new Route(
        Route.GET,
...
// PeopleController
routesManager.addRoute(
    new Route(Route.GET, "/people", PeopleController.index, "people:index")
);
routesManager.addRoute(
    new Route(
        Route.GET,
        "/person/:id",
        PeopleController.detail,
        "person:detail"
    )
);
routesManager.addRoute(
...
// Errors
routesManager.addRoute(
    new Route(Route.USE, "", HttpErrorController._404, "error:404")
);
